...
pub fn routes(app: &mut App<AppState, ()>) -> App<AppState, ()> {
    // Please try to keep in alphabetical order
    app.service(
        web::resource("/admin/stuck_domain_actions")
            .route(web::get().to(admin::admin_stuck_domain_actions)),
    )
    .service(web::resource("/admin/ticket_count").route(web::get().to(admin::admin_ticket_count)))
    .service(web::resource("/admin/orders").route(web::get().to(admin::orders)))
    .service(web::resource("/artists/search").route(web::get().to(artists::search)))
    .service(
        web::resource("/artists/{id}/toggle_privacy").route(web::put().to(artists::toggle_privacy)),
    )
    .service(
    ...
    .service(
        web::resource("/cart/clear_invalid_items")
    ...
    .service(
        web::resource("/events/{id}/redeem/{ticket_instance_id}")
    ...
    .service(
        web::resource("/events/{id}/ticket_types/multiple")
    ...
    .service(
        web::resource("/events/{id}/users/invites")
            .route(web::post().to(organization_invites::create_for_event)),
    )
    .service(
        web::resource("/events/{id}/users/invites/{invite_id}")
            .route(web::delete().to(organization_invites::destroy)),
    )
    .service(
        web::resource("/events/{id}/users/{user_id}").route(web::delete().to(events::remove_user)),
    )
    .service(
        web::resource("/external/facebook/pages").route(web::get().to(external::facebook::pages)),
    )
    .service(
        web::resource("/external/facebook/events")
            .route(web::post().to(external::facebook::create_event)),
    )
    .service(
        web::resource("/external/facebook/web_login")
            .route(web::post().to(external::facebook::web_login)),
    )
    .service(
        web::resource("/external/facebook/scopes").route(web::get().to(external::facebook::scopes)),
    )
    .service(web::resource("/genres").route(web::get().to(genres::index)))
    .service(web::resource("/invitations/{id}").route(web::get().to(organization_invites::view)))
    .service(
        web::resource("/invitations").route(web::post().to(organization_invites::accept_request)),
    )
    ...
    .service(
        web::resource("/orders/{id}/resend_confirmation")
    ...
    .service(
        web::resource("/organizations/{id}/events")
    ...
    .service(
        web::resource("/organizations/{id}/fans/{user_id}").route(web::get().to(users::profile)),
    )
    .service(
    ...
    .service(
        web::resource("/organizations/{id}/fans").route(web::get().to(organizations::search_fans)),
    )
    .service(
        web::resource("/organizations/{id}/invites/{invite_id}")
            .route(web::delete().to(organization_invites::destroy)),
    )
    .service(
        web::resource("/organizations/{id}/settlements").route(web::get().to(settlements::index)),
    )
    .service(
    ...
    .service(
        web::resource("/organizations/{id}/users/{user_id}")
            .route(web::delete().to(organizations::remove_user)),
    )
    .service(
        web::resource("/organizations/{id}/venues")
            .route(web::get().to(venues::show_from_organizations))
            .route(web::post().to(organizations::add_venue)),
    )
    .service(
    ...
    .service(
        web::resource("/payments/callback/{nonce}/{id}").route(web::get().to(payments::callback)),
    )
    ...
    .service(
        web::resource("/settlement_adjustments/{id}")
    ...
    .service(web::resource("/sitemap.xml").route(web::get().to(sitemap_gen::index)))
    .service(web::resource("/slugs/{id}").route(web::get().to(slugs::show)))
    .service(
        web::resource("/tickets/transfer").route(web::post().to(tickets::transfer_authorization)),
    )
    ...
    .service(
        web::resource("/tickets/{id}/redeem").route(web::get().to(tickets::show_redeemable_ticket)),
    )
    .service(
        web::resource("/transfers/transfer_key/{id}")
    ...
    .service(web::resource("/users/{id}").route(web::get().to(users::show)))
    .service(web::resource("/user_invites").route(web::post().to(user_invites::create)))
    .service(
        web::resource("/users/{id}/organizations").route(web::get().to(users::list_organizations)),
    )
    .service(
        web::resource("/venues/{id}/organizations")
            .route(web::post().to(venues::add_to_organization)),
    )
    .service(
    ...
    .service(
        web::resource("/venues/{id}/toggle_privacy").route(web::put().to(venues::toggle_privacy)),
    )
    .service(
    ...
    .default_service(|r: ServiceRequest| {
        r.into_response(HttpResponse::NotFound().json(json!({"error": "Not found"})))
    })
}
