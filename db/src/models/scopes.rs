...
impl fmt::Display for Scopes {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let s = match self {
            ...
            Scopes::ChatWorkflowDelete => "chat-workflow:delete",
            Scopes::ChatWorkflowRead => "chat-workflow:read",
            Scopes::ChatWorkflowWrite => "chat-workflow:write",
...
impl FromStr for Scopes {
    ...
    fn from_str(s: &str) -> Result<Self, <Self as FromStr>::Err> {
        let s = match s {
            ...
            "chat-workflow:delete" => Scopes::ChatWorkflowDelete,
            "chat-workflow:read" => Scopes::ChatWorkflowRead,
            "chat-workflow:write" => Scopes::ChatWorkflowWrite,
    ...
    let mut roles = match role {
        ...
        Admin => {
            let mut roles = vec![
                ...
                Scopes::ChatWorkflowDelete,
                Scopes::ChatWorkflowRead,
                Scopes::ChatWorkflowWrite,
